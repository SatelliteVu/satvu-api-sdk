...
if TYPE_CHECKING:
    from ..models.feature_order_1 import FeatureOrder1
    from ..models.price import Price


class ResellerFeatureCollectionOrder1(BaseModel):
    """
    Attributes:
        reseller_end_user_id (UUID): The ID of the end user for whom the order is placed for.
        id (UUID): The order ID.
        features (list[FeatureOrder1]): An array of Item objects.
    ...
    features: list[FeatureOrder1] = Field(
