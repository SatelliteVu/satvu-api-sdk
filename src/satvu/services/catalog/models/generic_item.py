...
from ..models.generic_item_type import GenericItemType

if TYPE_CHECKING:
    from ..models.generic_item_properties import GenericItemProperties
...
class GenericItem(BaseModel):
    ...
    Attributes:
        ...
        links (list[Link]):
        stac_version (str):
        type_ ('GenericItemType'):
        properties (Union[None, GenericItemProperties]):
    ...
    collection: str = Field(..., description=None, alias="collection")
    geometry: Union[
    ...
    type_: GenericItemType = Field(..., description=None, alias="type")
    properties: Union[None, GenericItemProperties] = Field(
