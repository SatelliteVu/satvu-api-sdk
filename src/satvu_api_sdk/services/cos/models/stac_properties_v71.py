...
if TYPE_CHECKING:
    ...
    from ..models.stac_properties_v71_processing_software_name_version import (
        StacPropertiesV71ProcessingSoftwareNameVersion,
    )


class StacPropertiesV71(BaseModel):
    """
    Attributes:
        ...
        processing_software (StacPropertiesV71ProcessingSoftwareNameVersion):
    ...
    processing_software: "StacPropertiesV71ProcessingSoftwareNameVersion" = Field(
