...
if TYPE_CHECKING:
    from ..models.geojson_polygon_1 import GeojsonPolygon1


class StacPropertiesV41(BaseModel):
    """
    Attributes:
    ...
    proj_geometry: "GeojsonPolygon1" = Field(
        ..., description=None, alias="proj:geometry"
    )
