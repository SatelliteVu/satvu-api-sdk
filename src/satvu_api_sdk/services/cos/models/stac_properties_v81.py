...
if TYPE_CHECKING:
    from ..models.polygon_3 import Polygon3
    from ..models.stac_properties_v81_processing_software_name_version import (
        StacPropertiesV81ProcessingSoftwareNameVersion,
    )


class StacPropertiesV81(BaseModel):
    """
    Attributes:
        ...
        processing_software (StacPropertiesV81ProcessingSoftwareNameVersion):
        ...
        proj_geometry (Union['Polygon3', None]): Defines the projected footprint.
    ...
    processing_software: "StacPropertiesV81ProcessingSoftwareNameVersion" = Field(
    ...
    proj_geometry: Union["Polygon3", None] = Field(
